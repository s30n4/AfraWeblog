        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastUpdatePasswordDateTime = table.Column<DateTimeOffset>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_NewsContents_Authors_AuthorId",
                        column: x => x.AuthorId,
                        principalSchema: "dbo",
                    ...
                    table.ForeignKey(
                        name: "FK_NewsContents_NewsCategories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_NewsContents_NewsId",
                        column: x => x.NewsId,
                        principalSchema: "dbo",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NewsLabels", x => x.Id);
                    table.ForeignKey(
                        name: "FK_NewsLabels_Labels_LabelId",
                        column: x => x.LabelId,
                        principalSchema: "dbo",
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NewsLabels_NewsContents_NewsId",
                        column: x => x.NewsId,
                        principalSchema: "dbo",
                        principalTable: "NewsContents",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NewsLabels_LabelId",
                table: "NewsLabels",
                column: "LabelId");

            migrationBuilder.CreateIndex(
                name: "IX_NewsLabels_NewsId",
                table: "NewsLabels",
                column: "NewsId");
        }
